...
- (void)pluginInitialize {
    ...
    _keyboardShowObserver = [nc addObserverForName:UIKeyboardWillShowNotification
                               ...
                               usingBlock:^(NSNotification* notification) {
                                   ...
                                   [weakSelf.commandDelegate evalJs:[NSString stringWithFormat:@"cordova.plugins.IonicKeyboard.isVisible = true; cordova.fireWindowEvent('native.keyboardshow', { 'keyboardHeight': %@ }); ", [@(keyboardFrame.size.height) stringValue]]];
    ...
    _keyboardHideObserver = [nc addObserverForName:UIKeyboardWillHideNotification
                               ...
                               queue:[NSOperationQueue mainQueue]
                               usingBlock:^(NSNotification* notification) {
                                   [weakSelf.commandDelegate evalJs:@"cordova.plugins.IonicKeyboard.isVisible = false; cordova.fireWindowEvent('native.keyboardhide'); "];
